            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li>
                        ...
                        <a href="upload.php"><i class="glyphicon glyphicon-open" aria-hidden="true"></i>&nbsp Unggah</a>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu1">
                            <li><a href="stem.php">Kueri Kata Dasar</a></li>
                            <li><a href="query.php">Kueri Boolean </a></li>
                            <li><a href="awalquery.php">Kueri Tf</a></li>
                            <li><a href="similaritas.php">Hitung Similaritas</a></li>
                            <li><a href="hitungbobot.php">Hitung Bobot</a></li>
                            <li><a href="hitungvektor.php">Hitung Vector</a></li>
                        </ul>
                        <a href="#pageSubmenu2" data-toggle="collapse" aria-expanded="false"><i class="glyphicon glyphicon-briefcase" aria-hidden="true"></i>&nbsp Data Master</a>
                            <ul class="collapse list-unstyled" id="pageSubmenu2">
                                <li><a href="tabel_up2.php">Data Dokumen</a></li>
                                <li><a href="tabel_up3.php">Data Kata Dasar</a></li>
                            </ul>
                        <a href="about.php"><i class="glyphicon glyphicon-user" aria-hidden="true"></i>&nbsp Tentang</a>
                    </li>
                </ul>
            </nav>
