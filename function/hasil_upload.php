 <?php
        ...
        if (strlen($filteredarray) >=4)
          {
            ...
            $hasil=$st2->Enhanced_CS($filteredarray);
  ...
  if (move_uploaded_file($lokasi_file,"$folder")){
    ...
    echo '  <br><br>
  <center><form action="tabel_up.php" method="GET">
          <input type="hidden" name="a" value="'.$nama_file.'">
          <input type="submit" name="submit" value="Lihat Table">
       </form><center>';
